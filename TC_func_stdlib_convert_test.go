...
func TestStdlibConvert6(t *testing.T) {
	code := "List convert['Hello'] println size"
	// SetVariable("tc.Debuglevel", "debug")
	tc := Init()
	// SetVariable("tc.Debuglevel", "info")
	tc = tc.Eval(code)
...
func TestStdlibConvert7(t *testing.T) {
	code := "String convert[List convert['Hello']] println size"
	// SetVariable("tc.Debuglevel", "debug")
	tc := Init()
	// SetVariable("tc.Debuglevel", "info")
	tc = tc.Eval(code)
