...
func TestStdlibRotate6display(t *testing.T) {
	code := "matrix[numbers[1 2 3] numbers[4 5]]  println "
	// SetVariable("tc.Debuglevel", "debug")
	tc := Init()
	// SetVariable("tc.Debuglevel", "info")
	tc = tc.Eval(code)
...
func TestStdlibRotate6(t *testing.T) {
	code := "matrix[numbers[1 2 3] numbers[4 5]] <<- println "
	// SetVariable("tc.Debuglevel", "debug")
	tc := Init()
	// SetVariable("tc.Debuglevel", "info")
...
func TestStdlibRotate7(t *testing.T) {
	code := "matrix[numbers[1 2 3] numbers[4 5]] ->> println "
	// SetVariable("tc.Debuglevel", "debug")
	tc := Init()
	// SetVariable("tc.Debuglevel", "info")
