...
// Adaptation to TSAK VM by Vladimir Ulogov. 2020
// Adaptation for ThreadComputation by Vladimir Ulogov. 2022
...
func intToBytes(n interface{}, size int) []byte {
	buf := bytes.NewBuffer([]byte{})
  switch size {
  case 8:
	   binary.Write(buf, binary.LittleEndian, int64(n.(int64)))
  case 4:
     binary.Write(buf, binary.LittleEndian, int32(n.(int64)))
  case 1:
     binary.Write(buf, binary.LittleEndian, int8(n.(int)))
  case 2:
      binary.Write(buf, binary.LittleEndian, int16(n.(int64)))
  }
